...
class PoppyEnv(object):
    ...
    def close(self):
        pb.disconnect()
    def close_gripper(self,direction,sleep=None):
        m = pb.setJointMotorControl2(self.robot_id, 6, pb.POSITION_CONTROL, targetPosition=direction)
    ...
    def inverse_kinematics_Orn(self, link_indices, target_positions, orn, num_iters=1000):
